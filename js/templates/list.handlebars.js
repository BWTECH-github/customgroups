...
templates['list'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form name=\"customGroupsCreationForm\">\r\n	<div>\r\n		<input type=\"text\" name=\"groupName\" placeholder=\""
    ...
    + "\" aria-label=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"newGroupPlaceholder") || (depth0 != null ? lookupProperty(depth0,"newGroupPlaceholder") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"newGroupPlaceholder","hash":{},"data":data,"loc":{"start":{"line":4,"column":88},"end":{"line":4,"column":111}}}) : helper)))
